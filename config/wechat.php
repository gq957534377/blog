...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wxd9058ab15676717a'),         // AppID
    'secret'  => env('WECHAT_SECRET', '8f1c8cac88d4c82f866d1f5d8396b5db'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'guo'),          // Token
...
//     ],
     ...
     */
     ...
     'mock_user' => [
         "openid" =>"oZIRCv4hfTX3XDfEcqrcq--U_1iY",
